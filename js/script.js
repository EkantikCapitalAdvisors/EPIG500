    ...
    (function setupArithmetic() {
        ...
        function updateBaselineIndicator() {
            ...
            el.innerHTML =
                ...
                +   '<em>Blended basis: the full engine record across <strong>both</strong> the ~18-month Telegram period (Apr 2023 – Oct 2024, pre-protocol — no in-advance witness or formal gates, traded at 1 /ES sizing) and the protocol-bound pre-registration period (May 19, 2026 forward, traded at /MES baseline on a $100K-equivalent account) — ' + trades + ' trades · ' + totalPts + ' pts · ' + months + ' active months. The Telegram portion is shown elsewhere for transparency and is <strong>not</strong> a witnessed/sustainability claim; blending it here raises the sample size at the cost of mixing witnessed and unwitnessed records, and mixing /ES and /MES sizing. The displayed $/yr extrapolates Period 1 to the /ES architectural cap; pure /MES baseline throughout would be ~28% of this. <strong>An estimate from past throughput, not a projection of any Ekantik strategy. Past performance does not guarantee future results.</strong> Updates automatically with every admin publish.</em>'
                + '</p>';
        }
